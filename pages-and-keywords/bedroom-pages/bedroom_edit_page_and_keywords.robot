...
${edit_lstbedroom_status_vacant}          xpath=//*[@id="bedroomStatusId"]/option[2]
${bedroom_edit-lstbedroom_type}           xpath=//*[@id="typeBedroomId"]
${edit_lstbedroom_type_clasicbedking}     xpath=//*[@id="typeBedroomId"]/option[2]
...
Edit_bedroom_info_and_change_bedtype
    ...
    # Click element                      ${edit_lstbedroom_status_vacant} 
    # Click element                      ${bedroom_edit-lstbedroom_type} 
    # Click element                      ${edit_lstbedroom_type_clasicbedking} 
